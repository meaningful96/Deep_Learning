...
# read txt file
wn_train_lines = read_txt("C:/Users/USER/Desktop/SimKGC/data/WN18RR/train.txt") #change path
wn_valid_lines = read_txt("C:/Users/USER/Desktop/SimKGC/data/WN18RR/valid.txt")
wn_test_lines = read_txt("C:/Users/USER/Desktop/SimKGC/data/WN18RR/test.txt") 
wn_txt_example = wn_train_lines
# wn_txt_examples = wn_train_lines + wn_test_lines +  wn_valid_lines

fb_train_lines = read_txt("C:/Users/USER/Desktop/SimKGC/data/FB15k237/train.txt")
fb_valid_lines = read_txt("C:/Users/USER/Desktop/SimKGC/data/FB15k237/valid.txt")
fb_test_lines = read_txt("C:/Users/USER/Desktop/SimKGC/data/FB15k237/test.txt")
fb_txt_example = fb_train_lines
# fb_txt_examples = fb_train_lines + fb_test_lines + fb_valid_lines

#-----------------------------------------------------------------------------------#

# read json file
wn_train = read_json("C:/Users/USER/Desktop/SimKGC/data/WN18RR/train.txt.json")
wn_valid = read_json("C:/Users/USER/Desktop/SimKGC/data/WN18RR/valid.txt.json")
wn_test  = read_json("C:/Users/USER/Desktop/SimKGC/data/WN18RR/test.txt.json")
wn_json_example = wn_train
# wn_json_examples_all = wn_train + wn_valid + wn_test

fb_train = read_json('C:/Users/USER/Desktop/SimKGC/data/FB15k237/train.txt.json')
fb_valid = read_json('C:/Users/USER/Desktop/SimKGC/data/FB15k237/valid.txt.json')
fb_test = read_json('C:/Users/USER/Desktop/SimKGC/data/FB15k237/test.txt.json')
fb_json_example = fb_train
# fb_json_examples_all = fb_train + fb_valid + fb_test
...
wn_txt_relh2tail, wn_txt_relt2head = read_txt_examples(wn_txt_example)
fb_txt_relh2tail, fb_txt_relt2head = read_txt_examples(fb_txt_example)
wn_json_relh2tail, wn_json_relt2head = read_json_examples(wn_json_example)
fb_json_relh2tail, fb_json_relt2head = read_json_examples(fb_json_example)
...
relation_label_path1 = "C:/Users/USER/Desktop/논문/연구/실험/Banchmark_Relation_Type/wn18rr/relation_label.txt"
relation_label_path2 = "C:/Users/USER/Desktop/논문/연구/실험/Banchmark_Relation_Type/fb15k-237/relation_label.txt"
relation_label_path3 = "C:/Users/USER/Desktop/논문/연구/실험/Banchmark_Relation_Type/wn18rr/relation_label.json"
relation_label_path4 = "C:/Users/USER/Desktop/논문/연구/실험/Banchmark_Relation_Type/fb15k-237/relation_label.json"
