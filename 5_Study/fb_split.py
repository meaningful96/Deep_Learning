...
G_wn = LinkGraph(train_path_fb)

all_positive_samples = []
# Iterate over the WordNet train set
for example in train_data_fb:
...
output_path = "C:/Users/USER/Desktop/json/FB15k237/test_HN.json"
...
"""
start_time = time.time()    
train_path_wn = "C:/Users/USER/Desktop/json/FB15k237/train.txt.json"
with open(train_path_wn, 'r', encoding='utf-8') as f:
    train_data_wn = json.load(f)

G_wn = LinkGraph(train_path_wn)

valid_path_wn = "C:/Users/USER/Desktop/json/FB15k237/valid.txt.json"
...
# Save the combined results to a JSON file
output_path = "C:/Users/USER/Desktop/json/FB15k237/positive_samples_valid.json"
with open(output_path, 'w', encoding='utf-8') as f:
    json.dump(all_positive_samples, f, ensure_ascii=False, indent=4)
...
"""
#%%
path = "C:/Users/USER/Desktop/json/FB15k237/test_HN.json"
